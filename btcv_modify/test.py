...
parser.add_argument('--logdir', default='/mnt', type=str, help='root directory to save outputs')
parser.add_argument(
...
def main():
    ...
    output_directory = args.logdir + args.exp_name    
