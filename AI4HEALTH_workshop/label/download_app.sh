...
singularity exec -B /blue/vendor-nvidia/hju/monailabel_samples:/workspace /blue/vendor-nvidia/hju/workshop_monailabel0.6.0 monailabel apps --download --name radiology --output /workspace/apps
